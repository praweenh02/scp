...
<div class="wrapper">
        ...
        <header class="panel-heading">
             ...
             <span class="mb-5 pull-right" style="margin-top: -6px;">
                <a  href="groupmanager/addMeeting/0/" class="btn btn-primary btn-sm" >
            ...
            foreach ($meeting_list as $group_data){?>
                ...
                <tr class="gradeX">
                  ...
                  <td><?=$group_data->group_title;?></td>
                   <td><?=$group_data->meeting_title;?></td>
                  ...
                  <td>
                    <a href="groupmanager/addMeeting//<?=$group_data->meeting_id;?>/" class="btn btn-xs btn-primary" title="Edit"><i class="fa 
fa-edit"></i> Edit</a> </td>  
