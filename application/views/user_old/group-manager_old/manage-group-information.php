        ...
        <tbody id="loadallData">
            ...
            ?>
                <tr class="gradeX">
                  ...
                  <td>
                    <button  onclick="get_groupinformation_modal('<?=$result2->group_information_id;?>','<?=$result2->group_id;?>');"   class="btn btn-xs btn-primary" title="Edit"><i class="fa 
fa-edit"></i> Edit</button> </td>  
                    <td><button onclick="deleteGroupInformation('<?=$result2->group_information_id;?>','<?=$result2->group_id;?>');" class="btn btn-xs btn-danger" title="Delete"><i class="fa 
