                      ...
                      <form class="cmxform form-horizontal adminex-form" id="form-question" name="form-question" method="post" enctype="multiple/form-data">
                            ...
                            'hash' => $this->security->get_csrf_hash());
                             ...
                             <input type="hidden" name="<?=$csrf['name'];?>" value="<?=$csrf['hash'];?>" /> 
                              <input type="hidden" name="sdobulletin_id" id="sdobulletin_id" value="<?=$result->sdobulletin_id;?>">
                                            ...
                                            <div class="col-md-12">
                                               ...
                                               <div class="form-group row">
                                                     <label for="cname" class="control-label col-lg-3">Bulletin Title </label>
                                                  <div class="col-lg-9">
                                                     <input type="text" name="bulletin_title" id="bulletin_title" class="form-control" value="<?=$result->bulletin_title;?>" required>
                                                   </div>
                                               </div>
                                                <div class="form-group row">
                                                     <label for="cname" class="control-label col-lg-3">Buelltin Description  *  </label>
                                                  <div class="col-lg-9">
                                                     <textarea class="form-control" id="bulletin_description" name="bulletin_description" required placeholder="Enter Description"><?=$result->bulletin_description;?></textarea>
                                                   </div>
                                               </div>
...
<script src="ajax/sdobulletin.js"></script>
