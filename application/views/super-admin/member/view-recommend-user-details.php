        ...
        <div class="panel-body">
           <div class="tab-content">
               <div class="tab-pane active " id="home-2">
                <form method="post" class="cmxform form-horizontal adminex-form" enctype="multipart/form-data" id="form-member" name="form-member" novalidate> 
                     <?php  $csrf = array(
                       ...
                       <div class="form-group row">
                        ...
                        <div class="form-group row">
                          <label for="cname" class="control-label col-lg-3">Pin Code -</label>
                           ...
                           <div class="form-group row">
                          <label for="cname" class="control-label col-lg-3">Accepted/Rejected -</label>
                            <div class="col-lg-9">
                            <select class="form-control" name="suerp_admin_status" required>
