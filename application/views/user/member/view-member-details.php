                            ...
                            <div class="tab-pane active " id="home-2" >
                                <form method="post" class="cmxform form-horizontal adminex-form" enctype="multipart/form-data" id="form-member1" name="form-member1" novalidate>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <?php
                                         if($result->group_manager_recommend_status==NULL OR $result->group_manager_recommend_status=='N')
                                         {
                                        ?>
                                        <div class="form-group row">
                                            <label for="cname" class="control-label col-lg-3">Recommend/Rejected -</label>
                                            <div class="col-lg-9">
