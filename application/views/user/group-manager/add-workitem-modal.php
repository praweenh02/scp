                                            ...
                                            <div class="form-group">
                                                          <label for="cname" >Question * </label>
                                                            ...
                                                            <select  name="question_id" id="question_id" class="form-control">
                                                                 ...
                                                                 <?php
                                                                  $query = $this->db->select('*')->where('question_status','Y')->where('group_id',$group_id)->order_by('question_id','ASC')->get('questions');     
                                                                  foreach($query->result() as $qresult)
                                                                  {
                                                                      
                                                                 ?>
                                                                  <option value="<?=$qresult->question_id;?>" <?=$qresult->question_id==$result->question_id? 'selected':'' ;?>><?=$qresult->question_no;?></option>
 <?php }?>
