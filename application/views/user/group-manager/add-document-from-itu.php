        ...
        <div class="panel-body">
            <div class="tab-content">
             <div class="tab-pane active " id="home-2">
              <form class="cmxform form-horizontal adminex-form" id="form-docfromitu" name="form-docfromitu" method="post" enctype="multiple/form-data">
                <?php  $csrf = array(
                   ...
                   <input type="hidden" name="document_from_itu_id" id="document_from_itu_id" value="<?=$result->document_from_itu_id;?>">
                   ...
                   <div class="col-md-12">
                                           ...
                                           <div class="form-group row">
                                               <label for="cname" class="control-label col-lg-3">Document from ITU site Title  </label>
                                               <div class="col-lg-9">
                                                   <input type="text" name="document_title" id="document_title" class="form-control " value="<?=$result->document_title;?>" required>
                                               </div>
                                           </div>
                                           ...
                                           <div class="form-group row">
                                               <label for="cname" class="control-label col-lg-3">Document  File  </label>
                                               <div class="col-lg-9">
                                                   <input type="file" name="document_file" id="document_file" class="form-control" value="" >
                                                   <?php
                                                    if($result->document_file)
                                                    {
                                                        echo '<a target="_blank" href="uploads/document-from-itu-site/'.$result->document_file.'" >File</a>';
                                                    }
                                               ...
                                               <?php
                                               if($result->document_from_itu_id)
                                               {
                                                 ?>
                                                 <div class="form-group row">
                                                   ...
                                                   <div class="col-lg-9">
                                                    <select  name="status" id="status" class="form-control">
                                                       ...
                                                       <option value="Y" <?=$result->document_status=='Y'? 'selected':'' ;?>>Active</option>
                                                       <option value="N" <?=$result->document_status=='N'? 'selected':'' ;?>>Inactive</option>
                                       ...
                                       <div class="form-group row">
                                         <div class="pull-right">
                                             ...
                                             <button class="btn btn-success btn-sm" onclick="save_doc_from_itusite();" type="button">Save changes</button>
                                         </div>
