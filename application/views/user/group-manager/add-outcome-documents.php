                ...
                <?php  $csrf = array(
                   ...
                   <div class="col-md-12">
                                                 ...
                                                 <div class="col-lg-9">
                                                   <select    required="" id="meeting_id" name="meeting_id"class="form-control align-right" style="float:right;" placeholder="Select First Working Group">
                                                     ...
                                                     if($result->meeting_id)
                                                     {
                                                        ...
                                                        ?>
                                                        <option value="$rows->meeting_id"><?=$rows->meeting_title;?> - <?=date('d-m-Y', strtotime($rows->meeting_date));?></option>
                                           ...
                                           <div class="form-group row">
                                               ...
                                               <div class="col-lg-9">
                                                   <input type="file" name="outcome_file" id="outcome_file" class="form-control" value="" >
                                                   <?php
                                                    if($result->outcome_file)
                                                    {
                                                        echo '<a target="_blank" href="uploads/outcome-documents/'.$result->document_file.'" >File</a>';
                                                    }
