                  ...
                  <input type="hidden" id="verified_email" name="verified_email" value="<?=base64_decode($verifyemail);?>">
                   <ul>
                       <li>
                           <div class="row">
                             <div class="col-md-12">
                                <input type="number" required id="otp" name="otp" maxlength="6" class="field-style field-split align-left" placeholder="Enter OTP *" />
                                <br>
                         ...
                         <div class="row">
                           <div class="col-md-6">
                             ...
                             <div class="col-md-6">   
                               ...
                               ?>
                               <select  id="state" name="state" required="" class="field-style  field-split align-left category"  placeholder="Select Working Group">
