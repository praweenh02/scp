                       ...
                       <li>
                           <div class="row">
                             ...
                             <p>Email list subscribed successfully.</p>
                                ...
                                <?php  }else{?>
                                      <div class="col-md-12">
                             <p><p>Your request for account on the Standards Coordination Portal has been submitted to your NWG Group Manager. You will receive an e-mail / message when the request is approved/rejected.<p>
<p>If you require any further assistance, please contact your focal point at <strong>adgcb.tec-dot@gov.in</strong> .</p>
                            </div>
