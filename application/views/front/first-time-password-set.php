   ...
   unset($_SESSION['error'])
	 ...
	 ?>
                <div class="alert alert-success" role="alert">
                  Please set first time password.
                 </div>
            
                  <form class="form-style-9" autocomplete="off"   method="post" id="form-setpassword" name="form-setpassword" enctype="multipart/form-data" novalidate >
                      <?php  $csrf = array(
                  ...
                  <input type="hidden" id="token" name="token" value="<?=$this->uri->segment('4');?>">
                   <ul>
                       <li>
                        ...
                        <li>
                          <button type="button"  onclick="set_password();" value="SIGN UP">SUBMIT</button> 
                     </li>
                   </ul>
                </form>
            </div>   
