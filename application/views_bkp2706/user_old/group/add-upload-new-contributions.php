                          ...
                          <div class="tab-pane active " id="home-2">
                                  <form class="cmxform form-horizontal adminex-form" id="form-upload1" name="form-upload1" method="post" enctype="multiple/form-data">
                                   ...
                                   <input type="hidden" name="group_id" id="group_id" value="<?=$this->uri->segment('4');?>">
                                      <input type="hidden" name="group_title" id="group_title" value="<?=$group_data->group_title;?>">
                                           ...
                                           <div class="col-md-12" id="reg-1">
                                               <div class="form-group row">
                                                  ...
                                                  <div class="col-lg-9">
                                                    <select  id="question_id" name="question_id" required="" class="form-control"  placeholder="Select Question">
                                                  ...
                                                  <div class="col-lg-9">
                                                     <select    required="" id="workitem_id" name="workitem_id" class="form-control align-right" placeholder="Select Working Group">
                                                         <option value="" selected disabled>---Select Work Item---</option>
                                                               <?php 
                                                          foreach($workitem_list as $workitem_data):
                                                         ?>
                                                          <option value="<?=$workitem_data->workitem_id;?>" <?=$workitem_data->workitem_id == $result->workitem_id? 'selected':'';?> ><?=$workitem_data->work_item;?></option>
                                                  ...
                                                  <div class="col-lg-9">
                                                     <select    required="" id="meeting_id" name="meeting_id" class="form-control" placeholder="Select Working Group">
                                                        <option value="" selected disabled>---Select Meeting---</option>
                                                         ...
                                                         ?>
                                                          <option value="<?=$meeting_data->meeting_id;?>" <?=$meeting_data->meeting_id == $result->meeting_id ? 'selected':'';?>><?=date('d-m-Y', strtotime($meeting_data->meeting_date));?></option>
