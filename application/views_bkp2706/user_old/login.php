...
<div class="container">
    ...
    <form class="form-signin" id="login-form" name="login-form" method="post" enctype="multiple/form-data" novalidate="novalidate">
            ...
            <input type="password" id="password" required  name="password" class="form-control" placeholder="Password">
              <?php
                            $protocol = (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off' || $_SERVER['SERVER_PORT'] == 443) ? "https://" : "http://";
                                ...
                                $current_domain =  $protocol . $domainName;
                                if($current_domain=='http://localhost/')
                                { ?>
                                       <div class="g-recaptcha" data-sitekey="6LdsADAcAAAAAPJ9txny26liRY2oRuwn0YUT29Ak"></div>

                                <?php }else if($current_domain=='https://tec1.dssolution.in/') { ?>
                                       <div class="g-recaptcha"    data-sitekey="6LcIRe4aAAAAAJrncaoWZaOvJJP2sxtsJfudsrPv"></div>


                                <?php }?>

            <button class="btn btn-lg btn-login btn-block" type="button" id="loginbtn">
              Sign In 
            </button>
