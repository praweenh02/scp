<?php error_reporting(0)?>
 ...
 <div class="page-heading">
            <h3>
                <?=$result->group_id==''? 'Add':'Edit';?> Meeting
            </h3>
            <hr>
                   </div>
                              ...
                              <input type="hidden" name="meeting_id" id="meeting_id" value="<?=$result->meeting_id;?>">
                                            ...
                                            <div class="col-md-12">
                                               ...
                                               <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                     <label for="cname"  class="control-label col-lg-3">Meeting Date * </label>
                                                  <div class="col-lg-9">
                                               ...
                                               <div class="form-group row">
                                                  ...
                                                  <div class="col-lg-9">
                                                       <input  class="form-control" id="meeting_file" name="meeting_file"  type="file" value=""   />
                                                 ...
                                                 if($result->meeting_id)
                                                   {
                                                   ?>
                                                   <a href="uploads/meeting-file/<?=$result->meeting_file;?>">File</a>
                                               <?php }?>
                                           </div>
                                               </div>
