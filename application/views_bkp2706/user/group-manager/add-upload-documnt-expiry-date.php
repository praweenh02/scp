                             ...
                             <input type="hidden" name="<?=$csrf['name'];?>" value="<?=$csrf['hash'];?>" /> 
                              <input type="hidden" name="documentexpirydate_id" id="documentexpirydate_id" value="<?=$result->documentexpirydate_id;?>">
                                            ...
                                            <div class="col-md-12">
                                               ...
                                               <div class="form-group row">
                                                   <label for="meeting_id" class="control-label col-lg-3">Select SDO Meeting *</label>
                                                    <div class="col-lg-9">
                                                     ...
                                                     {
                                                        $rows = $this->db->select('*')->where('meeting_id',$meeting_id)->get('group_meeting')->row();
                                                        ?>
                                                        <option value="$rows->meeting_id"><?=$rows->meeting_title;?> - <?=date('d-m-Y', strtotime($rows->meeting_date));?> to  - <?=date('d-m-Y', strtotime($rows->meeting_end_date));?></option>
