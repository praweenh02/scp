                              ...
                              <input type="hidden" name="meeting_id" id="meeting_id" value="<?=$result->meeting_id;?>">
                                            ...
                                            <div class="col-md-12">
                                               ...
                                               <div class="form-group row">
                                                  ...
                                                  <div class="col-lg-9">
                                                       <input  class="form-control" id="meeting_title" name="meeting_title"  type="text" value="<?=$result->meeting_title;?>" onkeypress="return /[0-9a-zA-Z]/i.test(event.key)"  required />
                                                   </div>
                                               </div>
                                                <div class="form-group row">
                                              ...
                                              <div class="form-group row">
                                                   <div class="pull-right">
                                                       ...
                                                       <button class="btn btn-success btn-sm btn-submit" onclick="save_meeting();" type="button">Save changes</button>
                                                   </div>
