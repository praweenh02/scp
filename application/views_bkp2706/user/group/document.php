                        ...
                        <table  id="dynamic-table" class="table table-bordered table-striped table-condensed">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php 
                                          if($sdo_result->bulletin_file)
                                          {
                                          ?>
                                         <a target="_blank" href="uploads/group-bulletin/<?=$sdo_result->bulletin_file;?>">
                                        <?php
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    {
                                        ?>
                                     <?=date('d-m-Y', strtotime($group_meeting->meeting_date));?> to <?=date('d-m-Y', strtotime($group_meeting->meeting_end_date));?></li>

                                <?php }else{ ?>
                               <?=date('d-m-Y', strtotime($group_meeting->meeting_date));?> 
                                 <?php }?>
