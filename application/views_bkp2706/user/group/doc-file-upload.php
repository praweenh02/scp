            ...
            ?>
                <tr class="gradeX">
                  ...
                  <td>
                   ...
                   <td>
                     <a  onclick="deleteData1('<?=$docreg_data->contribution_id ;?>','<?=$docreg_data->sdo_id;?>','<?=$docreg_data->group_id;?>');" class="btn btn-xs btn-danger" title="Edit"><i class="fa fa-trash-o"></i> Delete</a>
                 </td> 
