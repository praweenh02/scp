        ...
        <div class="panel-body">
            <div class="tab-content">
               <div class="tab-pane active " id="home-2">
                      <form class="cmxform form-horizontal adminex-form" id="form-question" name="form-question" method="post" enctype="multiple/form-data">
                                            <?php  $csrf = array(
                            ...
                            'hash' => $this->security->get_csrf_hash());
                             ...
                             <input type="hidden" name="<?=$csrf['name'];?>" value="<?=$csrf['hash'];?>" /> 
                              <input type="hidden" name="question_id" id="question_id" value="<?=$result->question_id;?>">
                                            ...
                                            <div class="col-md-12">
                                               ...
                                               <div class="form-group row">
                                                     <label for="cname" class="control-label col-lg-3">Question No. *  </label>
                                                  <div class="col-lg-9">
                                                     <input type="text" name="question_no" id="question_no" class="form-control" value="<?=$result->question_no;?>" required>
                                                   </div>
                                               </div>
                                                <div class="form-group row">
                                                     <label for="cname" class="control-label col-lg-3">Question Name *  </label>
                                                  <div class="col-lg-9">
                                                     <input type="text" name="question_name" id="question_name" class="form-control" value="<?=$result->question_name;?>" required>
                                                   </div>
                                               </div>
                                               <div class="form-group row">
                                                     <label for="cname" class="control-label col-lg-3">Website question  url *  </label>
                                                  <div class="col-lg-9">
                                                     <input type="url"  name="itu_website_que_url" id="itu_website_que_url" value="<?=$result->itu_website_que_url;?>"   class="form-control" required>
                                                   </div>
                                               </div>
                                                <div class="form-group row">
                                                     <label for="cname" class="control-label col-lg-3">Term of reference url *  </label>
                                                  <div class="col-lg-9">
                                                     <input type="url"  name="trem_url" id="trem_url" class="form-control" value="<?=$result->trem_url;?>" required>
                                                   </div>
                                               </div>
                                                 <!--<div class="form-group row">
                                                         ...
                                                         <div class="col-lg-9">
                                                            <select  name="status" id="status" class="form-control">
                                                                 <option value="0">---Select one---</option>
                                                                  <option value="Y" <?=$result->question_status=='Y'? 'selected':'' ;?>>Active</option>
                                                                     <option value="N" <?=$result->question_status=='N'? 'selected':'' ;?>>Inactive</option>
