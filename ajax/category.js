...
function save_data()
{
    ...
    if ($('#form-catgory').valid()) // check if form is valid
    {
        var group_id = $("#category_id").val();
       
        var form = $('#form-catgory')[0]; 
          formData = new FormData(form);
          formData.append('category_id',$("#category_id").val());
          //formData.append('group_desription', CKEDITOR.instances['group_desription'].getData());
         $.ajax({
            url: SITEROOT +'super-admin/group/save_category_data',
            type: "post",
        ...
        { 
          if(confirm("Are you sure you want to delete?"))
          {
           ...
           var $ele = $(this).parent().parent();
            $.post(SITEROOT + 'super-admin/group/delete_category', {id: id, csrf_token:csrf_token}, function (data) {deleteData
